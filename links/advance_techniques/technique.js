...
class technique_comments{
    ...
    passcomments(event){
        event.preventDefault();
        let params = 'techniquecomment= ' + this.commentPost.value;

        let xhr = new XMLHttpRequest();
        xhr.open('POST','../../script/php/techniquecomment.php', true);
        xhr.setRequestHeader('Content-type','application/x-www-form-urlencoded')
    ...
    fetchcomments(event){
        event.preventDefault();
        let xhr = new XMLHttpRequest();
        xhr.open('GET', '../../script/php/techniquefetchcomment.php',true);
...
let databaseSubmission = new technique_comments();
