...
class cutting_comments{
    ...
    passcomments(event){
        event.preventDefault();
        let params = 'cuttingcomment= ' + this.commentPost.value;

        let xhr = new XMLHttpRequest();
        xhr.open('POST','../../script/php/cuttingcomment.php', true);
        xhr.setRequestHeader('Content-type','application/x-www-form-urlencoded')
    ...
    fetchcomments(event){
        event.preventDefault();
        let xhr = new XMLHttpRequest();
        xhr.open('GET', '../../script/php/cuttingfetchcomment.php',true);
...
let databaseSubmission = new cutting_comments ();
