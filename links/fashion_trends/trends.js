...
class fashiontrend_comments{
    ...
    passcomments(event){
        event.preventDefault();
        let params = 'trendscomment= ' + this.commentPost.value;

        let xhr = new XMLHttpRequest();
        xhr.open('POST','../../script/php/fashiontrendscomment.php', true);
        xhr.setRequestHeader('Content-type','application/x-www-form-urlencoded')
    ...
    fetchcomments(event){
        event.preventDefault();
        let xhr = new XMLHttpRequest();
        xhr.open('GET', '../../script/php/fashiontrendfetchcomment.php',true);
